...
var app = (function () {
    ...
    */
    var n;function aa(a){var b=0;return function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}}}var ba="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value);};function ca(a){a=["object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof commonjsGlobal&&commonjsGlobal,a];for(var b=0;b<a.length;++b){var c=a[b];if(c&&c.Math==Math)return c}throw Error("Cannot find global object");}var r=ca(commonjsGlobal);
    ...
    var empty_pb = createCommonjsModule(function (module, exports) {
    ...
    goog.inherits(proto.google.protobuf.Empty, googleProtobuf.Message);
    ...
    goog.inherits(proto.server.GetItemsRequest, googleProtobuf.Message);
    if (goog.DEBUG && !COMPILED) {
      /**
       * @public
       * @override
    ...
    goog.inherits(proto.server.GetItemRequest, googleProtobuf.Message);
    if (goog.DEBUG && !COMPILED) {
      /**
       * @public
       * @override
    ...
    goog.inherits(proto.server.Item, googleProtobuf.Message);
    if (goog.DEBUG && !COMPILED) {
      /**
       * @public
       * @override
    ...
    goog.inherits(proto.server.CreateItemRequest, googleProtobuf.Message);
    if (goog.DEBUG && !COMPILED) {
      /**
       * @public
       * @override
    ...
    proto.server.GetItemsResponse = function(opt_data) {
      googleProtobuf.Message.initialize(this, opt_data, 0, -1, proto.server.GetItemsResponse.repeatedFields_, null);
    };
    goog.inherits(proto.server.GetItemsResponse, googleProtobuf.Message);
    if (goog.DEBUG && !COMPILED) {
      /**
       * @public
       * @override
    ...
    goog.inherits(proto.server.GetItemResponse, googleProtobuf.Message);
    if (goog.DEBUG && !COMPILED) {
      /**
       * @public
       * @override
    ...
    goog.inherits(proto.server.GeneralResponse, googleProtobuf.Message);
    if (goog.DEBUG && !COMPILED) {
      /**
       * @public
       * @override
    ...
    proto.server.Item.toObject = function(includeInstance, msg) {
      var obj = {
        id: googleProtobuf.Message.getFieldWithDefault(msg, 1, ""),
        title: googleProtobuf.Message.getFieldWithDefault(msg, 2, ""),
        description: googleProtobuf.Message.getFieldWithDefault(msg, 3, ""),
        closed: googleProtobuf.Message.getBooleanFieldWithDefault(msg, 4, false)
      };
    ...
    proto.server.CreateItemRequest.prototype.getItem = function() {
      return /** @type{?proto.server.Item} */ (
        googleProtobuf.Message.getWrapperField(this, proto.server.Item, 1));
    };
    ...
    */
    ...
    proto.server.GetItemsResponse.toObject = function(includeInstance, msg) {
      var obj = {
        itemsList: googleProtobuf.Message.toObjectList(msg.getItemsList(),
    ...
    proto.server.GetItemsResponse.prototype.getItemsList = function() {
      return /** @type{!Array<!proto.server.Item>} */ (
        googleProtobuf.Message.getRepeatedWrapperField(this, proto.server.Item, 1));
    };
    ...
    */
    ...
    proto.server.GetItemsResponse.prototype.addItems = function(opt_value, opt_index) {
      return googleProtobuf.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.server.Item, opt_index);
    };
